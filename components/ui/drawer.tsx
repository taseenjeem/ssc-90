  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[92vh] flex-col rounded-t-2xl border border-slate-200 bg-white shadow-2xl focus:outline-none",
          className
        )}
        {...props}
      >
        <div className="mx-auto mt-3 h-1.5 w-12 rounded-full bg-slate-300/80 shrink-0" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
