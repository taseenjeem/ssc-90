...
export default function CreateMemberDialog({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        toast.error(result.message || "তথ্য যাচাইকরণ ব্যর্থ হয়েছে।");
      }
    });
  };

  // Header snapshot preview
  const headerContent = (
    <div className="flex items-center gap-3 text-left">
      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-rose-100 text-rose-600 flex items-center justify-center shrink-0">
    ...
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
              <div>
                ...
                <Input
                  ...
                  className="rounded-xl border-slate-200 text-base sm:text-sm h-10 focus:ring-rose-500"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="rounded-xl border-slate-200 text-base sm:text-sm h-10 pl-9.5 focus:ring-rose-500"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="rounded-xl border-slate-200 text-base sm:text-sm h-10 pl-9.5 focus:ring-rose-500"
                    placeholder="যেমন: সরকারি চাকুরিজীবী, ব্যবসায়ী, শিক্ষক..."
                  />
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="স্কুল জীবনের প্রিয় স্মৃতি কিংবা বন্ধুদের উদ্দেশ্যে কিছু কথা..."
                />
              </div>
            </div>
          </TabsContent>
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <div className="flex flex-col gap-1.5 flex-1 min-w-0">
                      ...
                      >
                        ...
                        {uploadingAvatar ? "আপলোড হচ্ছে..." : "ছবি আপলোড করুন"}
                      </Button>
                      <input
                        ref={avatarInputRef}
                        type="file"
      ...
      <div className="px-4 sm:px-6 py-3 border-t border-slate-100 bg-slate-50/90 shrink-0 flex items-center justify-between gap-3">
        <div className="text-xs text-slate-500 hidden sm:block">
          সকল তথ্য পূরণ শেষে সংরক্ষণ করুন
        </div>
  ...
  const triggerButton = (
    <Button className="bg-rose-600 hover:bg-rose-700 text-white rounded-xl shadow-sm shadow-rose-200">
      <UserPlus className="w-4 h-4 mr-2" /> নতুন সদস্য যোগ করুন
    </Button>
  );

  // DESKTOP: Render centered Dialog Modal
  if (isDesktop) {
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="w-[96vw] sm:max-w-2xl md:max-w-3xl lg:max-w-4xl max-h-[92vh] flex flex-col p-0 overflow-hidden rounded-2xl bg-white border border-slate-200 shadow-2xl">
          <DialogHeader className="px-6 py-4 border-b border-slate-100 bg-slate-50/80 shrink-0">
            <DialogTitle className="sr-only">নতুন সদস্য যোগ করুন</DialogTitle>
            {headerContent}
          </DialogHeader>
          {formBody}
        </DialogContent>
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="max-h-[92vh] flex flex-col p-0 overflow-hidden rounded-t-2xl bg-white border-t border-slate-200 shadow-2xl">
        <DrawerHeader className="px-4 py-3 border-b border-slate-100 bg-slate-50/80 shrink-0 text-left">
          <DrawerTitle className="sr-only">নতুন সদস্য যোগ করুন</DrawerTitle>
          {headerContent}
        </DrawerHeader>
        {formBody}
      </DrawerContent>
